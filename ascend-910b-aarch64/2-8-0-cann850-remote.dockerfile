...
RUN python -m venv /app/.venv && \
    ...
    /app/.venv/bin/pip install --no-cache-dir torch==2.8.0 torchaudio==2.8.0 torchvision==0.23.0 numpy==1.26.4 && \
    /app/.venv/bin/pip install --no-cache-dir torch-npu==2.8.0.post2 && \
