...
RUN mkdir wheels && \
    wget -O wheels/fairseq2n-0.5.2-cp310-cp310-linux_aarch64.whl http://192.168.0.200:39000/wheels/aarch64/fairseq2n-0.5.2-cp310-cp310-linux_aarch64.whl && \
    /app/.venv/bin/pip install /wheels/fairseq2n-0.5.2-cp310-cp310-linux_aarch64.whl && \
    /app/.venv/bin/pip install fairseq==0.5.2 && \
    rm -rf wheels && \
